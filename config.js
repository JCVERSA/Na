...
module.exports = {
    ...
    // Dashboard
    dashboardPort: process.env.DASHBOARD_PORT || 8000,

    // Limits
    maxWarnings: 3,

    // ── Render Dashboard ─────────────────────────────────────────
    renderDashboard: process.env.RENDER_DASHBOARD_URL || '',
    renderSecret:    process.env.RENDER_SECRET || '',           // ← même valeur que NEBULA_SECRET sur Render
