...
<img src="utils/bot_image.jpg" alt="Nebula Bot" width="260">

</div>

Nebula Bot is a WhatsApp MD bot built on top of the **Baileys** library.  
...
After scanning, you will receive a **session string**. Copy that full string and paste it into `config.js`:

```js
sessionID: 'NebulaBot!H4.....'
```
...
### 2. Deploy on Panel (Katabump, etc.)
...
```bash
git clone https://github.com/your-repo/Nebula-Bot.git
cd Nebula-Bot
Always host it on this site https://control.bot-hosting.net/server/1af82067 it is a pterodactyl panel made for bot hosting Discord/Telegram etc. ..
```
...
- **Dark Neon** – Main developer & maintainer  
...
You must:
-Host the bot on this site https://control.bot-hosting.net/server/1af82067
